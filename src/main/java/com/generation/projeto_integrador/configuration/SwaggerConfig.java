package com.generation.projeto_integrador.configuration;
...
public class SwaggerConfig {
    ...
    OpenAPI springBlogPessoalOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("Projeto Integrador Delivery de Alimentos Latomata")
                .description("Projeto Integrador Delivery de Alimentos Latomata - Generation Brasil")
                .version("v0.0.1")
                .license(new License()
